...
class SignupEduProgramTest extends TestCase
{
	...
	public function getLegalInput()
	{
		return [
			...
			'ssid' => 'A123456789',
			'university_department' => 'NTCU CSIE',
			'university_department_dual' => '',
			'graduate_department' => 'NCTU CSIE',
			'graduate_department_dual' => '',
	...
	public function testCreateRequiredField()
	{
		$inputArr = [
			'name' => 29 ,
			'university_department' => 29 ,
			'graduate_department' => 29 ,
			'student_id' => 29 ,
			'ssid' => 11 ,
			'contact_addr_now' => 59 ,
